(function() {
    ...
    angular
        .module('app.settings')
        .controller('DialogEditPrefCusfieldPaymentController', DialogEditPrefCusfieldPaymentController);

    /** @ngInject */
    function DialogEditPrefCusfieldPaymentController($scope, $mdDialog, edit, data, $mdSidenav) {
