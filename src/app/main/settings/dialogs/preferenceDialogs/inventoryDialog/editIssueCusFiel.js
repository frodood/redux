(function() {
    ...
    angular
        .module('app.settings')
        .controller('DialogEditPrefIssueCusFielController', DialogEditPrefIssueCusFielController);

    /** @ngInject */
    function DialogEditPrefIssueCusFielController($scope, $mdDialog, edit, data, $mdSidenav) {
