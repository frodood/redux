(function() {
    ...
    angular
        .module('app.settings')
        .controller('DialogPrefreciptcusfieldsInventoryController', DialogPrefreciptcusfieldsInventoryController);

    /** @ngInject */
    function DialogPrefreciptcusfieldsInventoryController($scope, $mdDialog, $mdSidenav, data) {
