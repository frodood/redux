(function() {
    ...
    angular
        .module('app.settings')
        .controller('DialogPrefCusfieldEstimateController', DialogPrefCusfieldEstimateController);

    /** @ngInject */
    function DialogPrefCusfieldEstimateController($scope, $mdDialog, $mdSidenav, data) {
