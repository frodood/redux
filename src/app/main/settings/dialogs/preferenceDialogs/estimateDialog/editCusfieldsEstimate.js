(function() {
    ...
    angular
        .module('app.settings')
        .controller('DialogEditPrefICusfieldEstimateController', DialogEditPrefICusfieldEstimateController);

    /** @ngInject */
    function DialogEditPrefICusfieldEstimateController($scope, $mdDialog, edit, data, $mdSidenav) {
