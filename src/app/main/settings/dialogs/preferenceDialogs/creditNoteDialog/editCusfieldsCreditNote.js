(function() {
    ...
    angular
        .module('app.settings')
        .controller('DialogEditPrefICusfieldCreditNoteController', DialogEditPrefICusfieldCreditNoteController);

    /** @ngInject */
    function DialogEditPrefICusfieldCreditNoteController($scope, $mdDialog, edit, data, $mdSidenav) {
