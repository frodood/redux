(function() {
    ...
    angular
        .module('app.settings')
        .controller('DialogPrefCusfieldCreditNoteController', DialogPrefCusfieldCreditNoteController);

    /** @ngInject */
    function DialogPrefCusfieldCreditNoteController($scope, $mdDialog, $mdSidenav, data) {
