(function() {
    ...
    angular
        .module('app.settings')
        .controller('DialogPrefCusfieldExpenseController', DialogPrefCusfieldExpenseController);

    /** @ngInject */
    function DialogPrefCusfieldExpenseController($scope, $mdDialog, $mdSidenav, data) {
