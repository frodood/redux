(function() {
    ...
    angular
        .module('app.settings')
        .controller('DialogEditPrefCusfieldProductController', DialogEditPrefCusfieldProductController);

    /** @ngInject */
    function DialogEditPrefCusfieldProductController($scope, $mdDialog, edit, data, $mdSidenav) {
