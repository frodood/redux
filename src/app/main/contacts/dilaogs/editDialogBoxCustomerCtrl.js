  (function ()
{
    ...
    angular
        .module('app.contacts')
        .controller('DialogControllerEditCustomer', DialogControllerEditCustomer);

    /** @ngInject */
   // customerController.$inject = ['$mdDialog','$serviceCall','profileID'];

    function DialogControllerEditCustomer($scope, $mdDialog,$serviceCall,profileID,contactEditService,$mdToast,favouriteStar,favouriteStarNo,$customCtrl, msSpinnerService)
    {
    ...
    function editCustomer(val){
       ...
       if(!vm.contact.email || vm.contact.email == ""){
            ...
            vm.spinnerService.show('conCustomer-edit-spinner');
               ...
               // vm.contact.createDate = new Date();
                ...
                val.profileLog = {
                    ...
                    client.ifSuccess(function(data){
                      ...
                      contactEditService.removeArray(0);
                      contactEditService.setArray(val);
                      ...
                      vm.spinnerService.hide('conCustomer-edit-spinner'); 
                ...
                if(data.data.customMessage == null){
                    ...
                    .parent(angular.element(document.body))
                    .title('Error')
                    .content('Error Editing Customer')
                    .ariaLabel('Alert Dialog Demo')
                    .ok('OK')
                    .targetEvent()
                    );
